...
func main() {
	...
	bot.Handle("/clan_donate", clan.HandleClanDonateCommand)
	...
	bot.Handle("\fteleport_c", jobs.HandleTeleportConfirmCallback)
	bot.Handle("\fteleport_x", jobs.HandleTeleportCancelCallback)
	bot.Handle("\fghost_c", jobs.HandleGhostProtocolConfirmCallback)
	bot.Handle("\fghost_x", jobs.HandleGhostProtocolCancelCallback)
	bot.Handle("\fhyperspeed_c", jobs.HandleHyperSpeedConfirmCallback)
	bot.Handle("\fhyperspeed_x", jobs.HandleHyperSpeedCancelCallback)
	bot.Handle("\fextendplanet_c", jobs.HandleExtendPlanetConfirmCallback)
	bot.Handle("\fextendplanet_x", jobs.HandleExtendPlanetCancelCallback)
	bot.Handle("\forbitalmvr_c", jobs.HandleOrbitalManeuverConfirmCallback)
	bot.Handle("\forbitalmvr_x", jobs.HandleOrbitalManeuverCancelCallback)
	bot.Handle("\frepairunits_c", jobs.HandleRepairUnitsConfirmCallback)
	bot.Handle("\frepairunits_x", jobs.HandleRepairUnitsCancelCallback)
	bot.Handle("\frepairbldg_c", jobs.HandleRepairBuildingsConfirmCallback)
	bot.Handle("\frepairbldg_x", jobs.HandleRepairBuildingsCancelCallback)
	...
	bot.Handle("\fclandonate_c", clan.HandleClanDonateConfirmCallback)
	bot.Handle("\fclandonate_x", clan.HandleClanDonateCancelCallback)
	...
	bot.Handle("\fmarket_page", exchange.HandleExchangePageCallback)
	bot.Handle("\fbulk_buy_menu", exchange.HandleBulkBuyMenuCallback)
	bot.Handle("\fbulk_buy", exchange.HandleBulkBuyCallback)
	bot.Handle("\fcustom_listing_info", exchange.HandleCustomListingInfoCallback)
